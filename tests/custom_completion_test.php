...
/**
 * Class for unit testing mod_collaborate/activity_custom_completion.
 *
 * @package   mod_collaborate
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class custom_completion_test extends advanced_testcase {
    ...
    public function test_get_defined_custom_rules() {
        ...
        $this->assertEquals('completionlaunch', reset($rules));
    }
    ...
    public function test_is_defined() {
        ...
        // Rule is defined.
        $this->assertTrue($customcompletion->is_defined('completionlaunch'));
